...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--structured_shape_iter', type=int, default=3000,
                            help='starting iterations for using segmentation as prior for SF')
        ...
        parser.add_argument('--position_based_range', type=int, default=3,
                            help='Define the range for the position-based selection strategy (PBS). In percentage')
        parser.add_argument('--include_mask_val', action='store_true', default=False,
                            help='Whether you want to observe mask generation in val set')
